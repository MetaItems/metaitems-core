defmodule Metaitems.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Metaitems.Repo)
  ...
  """
  def valid_password?(%Metaitems.Accounts.User{hashed_password: hashed_password}, password)
