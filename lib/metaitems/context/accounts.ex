defmodule Metaitems.Context.Accounts do
  @moduledoc """
  ...
  alias Metaitems.Accounts.{Follows, User, UserToken, UserNotifier}
  ...
  def reset_user_password(user, attrs) do
   ...
   @doc """
  Log out user. Deletes all user Tokens, broadcast to liveview to disconnect users

  ## Examples

      iex> log_out_user(token)
      {:ok, %User{}}
  ...
  def log_out_user(token) do
    ...
    # Broadcast to liveview to disconnect user
    MetaitemsWeb.Endpoint.broadcast_from(
      self(),
